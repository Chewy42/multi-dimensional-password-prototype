    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow bg-[#f0f4f9] relative flex flex-col justify-center align-top">
        ...
        <div className="mx-auto mt-[150px] mb-auto py-[36px] w-full sm:w-[70%] bg-white rounded-[28px] border-2">
          ...
          <p className="block text-primary font-semibold select-none mb-2 relative text-center m-auto">
            Password Sequence
          </p>
                    ...
                    <div className="relative border rounded-lg shadow-sm w-full group">
                      ...
                      {input.type === "text" ? (
                        <input
                          ...
                          className="pl-10 pr-3 py-2 w-full h-[45px] border rounded focus:outline-none focus:border-black focus:border-primary select-none hover:cursor-pointer hover:outline "
                          value={input.value || ""}
                        />
                      ) : (
                        <>
              ...
              <div className="w-[100%] h-[100%] my-auto flex flex-col">
                <div className="flex justify-center align-middle relative">
                  <div className="flex justify-center align-middle">
                    <BsClipboard
                      onClick={() => {
                        navigator.clipboard.writeText(constructedPassword);
                        setErrorMessage("Copied to clipboard!");
                      }}
                      className="absolute left-1 w-4 h-4 top-1 text-black hover:cursor-pointer"
                    />
              ...
              <div className="w-[100%] h-[100%] my-auto flex flex-col">
                <div className="flex justify-center align-middle relative">
                  <div className="flex justify-center align-middle">
                    <BsClipboard
                      onClick={() => {
                        navigator.clipboard.writeText(hashedPass);
                        setErrorMessage("Copied to clipboard!");
                      }}
                      className="absolute left-1 w-4 h-4 top-1 text-black hover:cursor-pointer"
                    />
